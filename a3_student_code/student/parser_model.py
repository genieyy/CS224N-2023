...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.init.xavier_uniform_(nn.Parameter(torch.empty(n_features*self.embed_size, self.hidden_size)))
    ...
    def forward(self, w):
        ...
        h=self.dropout(F.relu(self.embedding_lookup(w)@self.embed_to_hidden_weight+self.embed_to_hidden_bias))
